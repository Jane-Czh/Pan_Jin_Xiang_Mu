  ...
  data() {
    return {
      ...
      allIndex: [
        ...
        { id: '20', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'interests', apiName: 'getManagementExpenseData', date: '', yDataName: 'ManagementExpense', type: '2', icon: 'el-icon-s-data', title: '当月管理费用', dataName: '金额', content: '', sum: 'managementExpense' },
        { id: '21', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'interests', apiName: 'getRdExpenseData', date: '', yDataName: 'RD_Expense', type: '2', icon: 'el-icon-s-data', title: '当月研发费用', dataName: '金额', content: '', sum: 'rdExpense' },
        { id: '22', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'month', apiName: 'getManufacturingExpensesMonthData', date: '', yDataName: 'Manufacturing_Expenses_Month', type: '2', icon: 'el-icon-s-data', title: '当月制造费用', dataName: '金额', content: '', sum: 'manufacturingExpensesMonth' },
        ...
        { id: '30', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'balance', apiName: 'getGrowthRateInventoryAndSalesData', date: '', yDataName: 'GrowthRate_Sales', yDataName2: 'GrowthRate_Inventory', type: '2', icon: 'el-icon-s-data', title: '存货增长率/销售增长率', dataName: '增长率', content: '', sum: 'growthRateInventory', sum2: 'growthRateSales' },
        { id: '32', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'balance', apiName: 'getTurnoverRateReceivableData', date: '', yDataName: 'TurnoverRate_Receivable', type: '3', icon: 'el-icon-s-data', title: '应收账款周转率', dataName: '周转率', content: '', sum: 'turnoverRateReceivable' },
        { id: '33', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'month', apiName: 'getCapitalTurnoverRateData', date: '', yDataName: 'Capital_Turnover_Rate', type: '3', icon: 'el-icon-s-data', title: '当月资金周转率', dataName: '周转率', content: '', sum: 'capitalTurnoverRate' },
        { id: '34', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'month', apiName: 'getInventoryTurnoverRateData', date: '', yDataName: 'Inventory_Turnover_Rate', type: '3', icon: 'el-icon-s-data', title: '当月库存商品周转率', dataName: '周转率', content: '', sum: 'inventoryTurnoverRate' },
        { id: '35', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'month', apiName: 'getRawMaterialTurnoverRateData', date: '', yDataName: 'Raw_Material_Turnover_Rate', type: '3', icon: 'el-icon-s-data', title: '当月原材料周转率', dataName: '周转率', content: '', sum: 'rawMaterialTurnoverRate' },
        { id: '36', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'month', apiName: 'getInprogressTurnoverRateData', date: '', yDataName: 'InProgress_Turnover_Rate', type: '3', icon: 'el-icon-s-data', title: '当月在制品周转率', dataName: '周转率', content: '', sum: 'inprogressTurnoverRate' },
        { id: '66', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'month', apiName: 'getLongEstimatedItemsData', date: '', yDataName: 'Long_Estimated_Items', type: '3', icon: 'el-icon-s-data', title: '一年以上暂估行项目', dataName: '项目', content: '', sum: 'longEstimatedItems' },
        ...
        { id: '78', showTarget: true, showType: 'NEW', showWarning: false, targetValue: '', targetValueDate: '', kind: 'month', apiName: 'getAddedValueMonthlyData', date: '', yDataName: 'Added_Value_Monthly', type: '1', icon: 'el-icon-s-data', title: '当月经济增加值', dataName: '金额', content: '', sum: 'addedValueMonthly' },
      ]
    }
  },
  computed: {},
