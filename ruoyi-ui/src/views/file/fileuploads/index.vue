  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="制度标题" prop="regulationsTitle">
        <el-input v-model="queryParams.regulationsTitle" placeholder="请输入制度标题" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="适用范围" prop="useScope">
        <el-input v-model="queryParams.useScope" placeholder="请输入适用范围" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="制度内容" prop="regulationsAddress">
        <el-input v-model="queryParams.regulationsAddress" placeholder="请输入制度内容" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="文件类型" prop="fileType">
        <el-input v-model="queryParams.fileType" placeholder="请输入文件类型" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="制度创建人" prop="createUsername">
        <el-input v-model="queryParams.createUsername" placeholder="请输入制度创建人" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="制度使用状态" prop="useState">
        <el-input v-model="queryParams.useState" placeholder="请输入制度使用状态" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="制度所属科室" prop="departmentCategory">
        <el-input v-model="queryParams.departmentCategory" placeholder="请输入制度所属科室" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="制度标签名称" prop="fileTag">
        <el-input v-model="queryParams.fileTag" placeholder="请输入制度标签名称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="历史版本制度" prop="oldRegulationsId">
        <el-input v-model="queryParams.oldRegulationsId" placeholder="请输入历史版本制度" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="修订人" prop="reviser">
        <el-input v-model="queryParams.reviser" placeholder="请输入修订人" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
