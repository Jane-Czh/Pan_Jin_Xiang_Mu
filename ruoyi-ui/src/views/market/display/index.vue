  ...
  data() {
    ...
    formData: { // 表单数据模型
      ...
      allIndex: [
        ...
        { id: '39', icon: 'el-icon-s-data', title: '商品车计划兑现率', content: '企业主要营业产品财务收入', path: '/financial/netProfit' },
        { id: '40', icon: 'el-icon-s-data', title: '订单兑现率', content: '企业主要营业产品财务收入', path: '/financial/managementExpense' },
        { id: '42', icon: 'el-icon-s-data', title: '大叉位叉车整机交货天数平均数', content: '企业主要营业产品财务收入', path: '/financial/rdExpense' },
        { id: '43', icon: 'el-icon-s-data', title: '电动车整机交货天数', content: '企业主要营业产品财务收入', path: '/financial/manufacturingExpensesMonth' },
        { id: '44', icon: 'el-icon-s-data', title: '小吨位内燃叉车整机交货天数', content: '企业主要营业产品财务收入', path: '/financial/monthlyRawMaterialInventory' },
