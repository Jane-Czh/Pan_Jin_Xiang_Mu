...
<!--      &lt;!&ndash; 添加输入框 &ndash;&gt;-->
<!--      &lt;!&ndash; <el-input v-model.number="numberInput" placeholder="请输入订单总台数"></el-input> &ndash;&gt;-->
...
<!--      </el-date-picker>-->
<!--      &lt;!&ndash; <p>{{ this.timeData.startTime }},{{ this.timeData.endTime }}</p> &ndash;&gt;-->
<!--    </div>-->
...
<!--      },-->
<!--      // selectedDate: 本年1月1日到本年12月1日-->
<!--      selectedDate: [new Date(new Date().getFullYear(), 0, 1), new Date()],-->
