<template>
    ...
    <el-date-picker
      v-model="value1"
      type="date"
      placeholder="选择日期"  @change="handleDateChange1">
    </el-date-picker>
  </div> -->
<!-- <el-date-picker v-model="value1" type="month" start-placeholder="选择月份" :picker-options="pickerOptions" @change="handleDateChange1">
</el-date-picker> -->
    ...
    data() {
        ...
        numbers : [],
            ...
            selectedDate: [new Date('2024-01-02'),new Date('2024-10-01')],
              value1: [new Date('2024-01-02'),new Date('2024-10-01')],
            pickerOptions: [],
            option: {},
            myChart: {}
        }
...
,
    ...
    return groupedData;
        ...
        //     this.timeData1.startTime = this.value1[0],
        //         this.timeData1.endTime = this.value1[1]
        //          this.timeData1.numberInput=this.numberInput
        //     try {
        //         this.loading = true
        //         console.log(this.timeData1)
        //         this.result = await getIndex15(this.timeData1);
        //         console.log("======>");
        //           console.log("后端传过来的数据：", this.result[0]);
        //            console.log("后端传过来的数据：", this.result[0].branch);
        //            console.log("后端传过来的数据：", this.result[0].yearMonth);
