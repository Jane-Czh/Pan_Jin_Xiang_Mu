<template>
  ...
  >
    <el-tabs tab-position="left">
      ...
      <el-tab-pane label="如何绑定文件">
        <el-divider content-position="left">如何绑定文件</el-divider>
        <div>
          点击流程节点中的链接标志:
          <i class="el-icon-paperclip"></i> 为绑定表单文件,
