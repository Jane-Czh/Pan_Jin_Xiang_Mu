...
public class FinancialIndicatorsHandfillTable extends BaseEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("Reporter", getReporter()).append("reportingDate", getReportingDate())
                .append("updatedBy", getUpdatedBy()).append("updatedDate", getUpdatedDate())
                .toString();
    }
...
//    @Override
//    public String toString() {
//        return "FinancialIndicatorsHandfillTable{" +
//                "fihfId=" + fihfId +
//                ", yearAndMonth=" + yearAndMonth +
//                ", totalSalesRevenue=" + totalSalesRevenue +
//                ", externalGroupSalesRevenue=" + externalGroupSalesRevenue +
//                ", totalVehicleProduction=" + totalVehicleProduction +
//                ", totalVehicleSales=" + totalVehicleSales +
//                ", newProductSalesRevenue=" + newProductSalesRevenue +
//                ", specialtyProductRevenue=" + specialtyProductRevenue +
//                ", totalSalesCost=" + totalSalesCost +
//                ", manufacturingExpensesMonth=" + manufacturingExpensesMonth +
//                ", reserveCarAmount=" + reserveCarAmount +
//                ", capitalTurnoverRate=" + capitalTurnoverRate +
//                ", inventoryTurnoverRate=" + inventoryTurnoverRate +
//                ", rawMaterialTurnoverRate=" + rawMaterialTurnoverRate +
//                ", inprogressTurnoverRate=" + inprogressTurnoverRate +
//                ", longEstimatedItems=" + longEstimatedItems +
//                ", inprogressDayrevenue=" + inprogressDayrevenue +
//                ", addedValueMonthly=" + addedValueMonthly +
//                ", reporter='" + reporter + '\'' +
