  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="一线从业人数-填报" prop="employeesNumber">
        <el-input v-model="queryParams.employeesNumber" placeholder="请输入一线从业人数-填报" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="公司平均从业人数" prop="employeesAvgMonthlyNumber">
        <el-input v-model="queryParams.employeesAvgMonthlyNumber" placeholder="请输入公司平均从业人数" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="公司平均从业人数" prop="employeesAvgAnnualNumber">
        <el-input v-model="queryParams.employeesAvgAnnualNumber" placeholder="请输入公司平均从业人数" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="工资总额月度值-填报" prop="totalMonthlySalary">
        <el-input v-model="queryParams.totalMonthlySalary" placeholder="请输入工资总额月度值-填报" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="工资总额月度占比" prop="monthlySalaryRatio">
        <el-input v-model="queryParams.monthlySalaryRatio" placeholder="请输入工资总额月度占比" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="工资总额年度占比" prop="annualSalaryRatio">
        <el-input v-model="queryParams.annualSalaryRatio" placeholder="请输入工资总额年度占比" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="累计人均收入" prop="cumulativeAverageIncome">
        <el-input v-model="queryParams.cumulativeAverageIncome" placeholder="请输入累计人均收入" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="月度累计生产人均收入" prop="monthlyProductionAvgIncome">
        <el-input v-model="queryParams.monthlyProductionAvgIncome" placeholder="请输入月度累计生产人均收入" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="月度累计职能人均收入" prop="monthlyFunctionalAvgIncome">
        <el-input v-model="queryParams.monthlyFunctionalAvgIncome" placeholder="请输入月度累计职能人均收入" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="职能部门人均加班费用" prop="functionalDeptOvertimeCost">
        <el-input v-model="queryParams.functionalDeptOvertimeCost" placeholder="请输入职能部门人均加班费用" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
