...
/**
 * 劳动合同台账导入对象 Enterprise_Management_Labor_Contract_Ledger
 * 
 * @author ruoyi
 * @date 2024-04-24
 */
public class EnterpriseManagementLaborContractLedger extends BaseEntity
{
    ...
    public void setEmlcId(Long emlcId) 
    {
        this.emlcId = emlcId;
    }

    public Long getEmlcId() 
    {
        return emlcId;
    }
