...
//    }
    @Override
    public int insertOrUpdateNonStandardData(Tech tech) {
        return techMapper.insertOrUpdateNonStandardData(tech);
    }

    @Override
    public void insertOrUpdateProjectData(Tech tech) {
        techMapper.insertOrUpdateProjectData(tech);
    ...
    @Override
    public List<TechNewProjectProgressDTO> selectProjectProgress(Date startTime, Date endTime) {
        return techMapper.selectProjectProgress(startTime, endTime);

    }

    @Override
    public List<TechNewProjectCompletionDTO> selectProjectCompletion(Date startTime, Date endTime) {
        return techMapper.selectProjectCompletion(startTime, endTime);
    ...
    public int updateTechAllData() {
        ...
        for (Date date = minMonth; date.before(DateUtils.getNextMonth(maxMonth)); date = DateUtils.getNextMonth(date)) {
            Tech tech = techMapper.selectTechByDate(date);
